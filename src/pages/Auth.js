    ...
    return (
        <Container>
            <Form onSubmit={onSubmit}>
                ...
                <Form.Control value={email} on onChange={onEmailChanged} type="email" placeholder="Enter email" />
                <Form.Text className="text-muted">
                 ...
                 <Form.Control value={password} on onChange={onPasswordChanged} type="password" placeholder="Password" />
                     </Form.Group>
